...
const dataBody = [
    ...
    {dimension: "Handlebar", sizeS: "400", sizeM: "420", sizeL: "440", sizeXL: "460", reference: ""},

];

class GeometryModel1 extends React.Component {
        ...
        return (
            <div>
                <div className="text-center" style={{ marginTop: "30px" }}>
                    <img src="images/model1.png" className="image-geometries" alt="Velox Go | Model 1" />
                </div>
